...
<title> Log in TVSConsult | Business consulting | Aalborg </title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="description" content="Log in to TVS Consult to read, insert, update or delete details about accounts. After log in to TVS Consult additional user details will be available including applications, user details and others.">
...
<c:choose>
  ...
  <c:otherwise>
		...
		<li  class="active"><a href="${loginUrl}"><span class="glyphicon glyphicon-log-in"></span> Log in</a></li>
	</c:otherwise>
</c:choose>
...
<h2 class="frontImagetext1 wow fadeIn" style="text-align: left;color: #1d1c1a;">Log in</h2>
<br/>
<c:url value="/login" var="loginUrl"/>
<form action="${loginUrl}" method="post">       
	...
	<input type="hidden"                        
		...
		value="${_csrf.token}"/>
	<div>
		<button type="submit" class="btn btnfr btn-lg" style="height:60px;"><h4 style="line-height:20px;font-weight: bold;font-size: 16px; ">Log in</h4></button>
	</div>
	<br />
	<c:if test="${msg != null}">       
