...
<nav class="navbar navbar-default" style="background-color: #333;">
  <div class="container-fluid">
   ...
   <ul class="nav navbar-nav">
        <li><a data-ajax="false" data-ajax="false" href="${indexUrl}">Home</a></li>
        
        <c:url var="projectsUrl" value="/projects"/>
        <li><a data-ajax="false" data-ajax="false" href="${projectsUrl}">Projects</a></li>

        <c:url var="aboutusUrl" value="/aboutus"/>
        <li><a data-ajax="false" data-ajax="false" href="${aboutusUrl}">About us</a></li>

        <c:url var="contactUrl" value="/contacts"/>
        <li><a data-ajax="false" data-ajax="false" href="${contactUrl}">Contact</a></li>
      </ul>
      
    <ul class="nav navbar-nav navbar-right">
       <c:url var="signUrl" value="/createuser"/>
        <li><a data-ajax="false" data-ajax="false" href="${signUrl}"><span class="glyphicon glyphicon-new-window"></span> Sign Up</a></li>
