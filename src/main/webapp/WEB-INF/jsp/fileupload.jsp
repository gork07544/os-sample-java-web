...
<title> File upload TVSConsult | Business consulting | Aalborg </title>
   <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="description" content="Take a look in the biggest database set which consists of very useful information about public financial funds available for applicants.">
...
<form  method="post" enctype="multipart/form-data" action="${fileupload}">
	<div class="form-group">
		<label for="lab1">Upload image 1</label>

  		<label class="btn btn-primary" id="lab1" for="file">
		<input type="file" id="file" name="file"  accept="image/jpeg" />
			Upload file
	</label>
	</div>
	<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
	<button type="submit" value="Upload"  class="btn btn-primary btn-large"><span class="glyphicon glyphicon-log-out"></span> Upload </button>
</form>
